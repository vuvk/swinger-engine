...
import swingraycaster.objects.creatures.enemy.EnemyState;
...
public abstract class Enemy extends Creature {   
    ...
    */
    ...
    public void setState(final EnemyState state) {
        ...
        switch (state) {
            ...
            case PAIN:
                Sound.playRandom(true, getPainSounds());
    ...
    */
    ...
    private void notice() {
        noticed = true;
        Sound.playRandom(getAlarmSounds());
