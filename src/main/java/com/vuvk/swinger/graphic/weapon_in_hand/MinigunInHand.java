...
public class MinigunInHand  extends RayWeaponInHand {
    private final static int FRAMES_COUNT = 2;
    private final static Image[] FRAMES = new Image[FRAMES_COUNT];
    private final static String[] FILES = { 
        "resources/pics/weapons/minigun0.png", 
        "resources/pics/weapons/minigun1.png"
    };
    ...
    private final static double ANIM_SPEED = 20.0;
    private final static double SHOOT_DELAY = 0.005;
    private final static double DAMAGE = 3.0;
