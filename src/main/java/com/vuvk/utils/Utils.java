...
public final class Utils {
    ...
    public static void arrayFastFill(Object[] array, final Object value) {
        final int len = array.length;
        if (len > 0) {
            array[0] = value;
        }
    ...
    public static void arrayFastCopy(Object[] src, final Object[] dest) {
        System.arraycopy(src, 0, dest, 0, src.length);
    }
    
    public static void arrayFastCopy(Object src, int srcPos, final Object dest, int destPos, int length) {
